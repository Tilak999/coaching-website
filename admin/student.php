...
<?php
    ...
    {
        $selector =  $email = mysqli_real_escape_string($conn,$_GET['selector']);
        $search =  $email = mysqli_real_escape_string($conn,$_GET['search']);
                        ...
                        if($result)
                        {
                            while($row = $result->fetch_assoc())
                            {
                                ...
                                echo "<tr>".
                                        ...
                                        "<td>$mobile</td>".
                                        "<td>$registered_on</td>".
                                        "<td align=\"center\" onclick=><span class=\"glyphicon glyphicon-trash\"></span></td>".
                                     "</tr>";
                            }
                        }
                        ?>
